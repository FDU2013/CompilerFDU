...
bb4:                                              ; preds = %bb3
  ...
  %r185 = load i32, ptr %r105, align 4
  %r186 = sub i32 %r183, 2
...
bb10:                                             ; preds = %bb8
  %r194 = sub i32 %r183, 1
  %r195 = add i32 %r194, 0
  %r124 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r195
...
bb12:                                             ; preds = %bb11
  %r132 = getelementptr i32, ptr %r100, i32 %r198
  %r201 = load i32, ptr %r132, align 4
  %r202 = sub i32 %r183, 1
...
bb14:                                             ; preds = %bb12
  %r140 = getelementptr i32, ptr %r100, i32 %r198
  %r205 = load i32, ptr %r140, align 4
  %r206 = add i32 %r205, 0
  br label %bb16
...
bb18:                                             ; preds = %bb17
  ...
  %r213 = load i32, ptr %r153, align 4
  %r214 = icmp ne i32 %r213, 0
  br i1 %r214, label %bb20, label %bb21

bb20:                                             ; preds = %bb18
  %r157 = getelementptr [10 x i32], ptr %r110, i32 0, i32 %r198
...
bb13:                                             ; preds = %bb11
  ...
  %r222 = load i32, ptr %r162, align 4
  ret i32 %r222
}
