...
bb2:                                              ; preds = %bb3, %bb1
  ...
  %r107 = getelementptr i32, ptr %r100, i32 %r164
  %r165 = load i32, ptr %r107, align 4
  %r166 = icmp sgt i32 %r160, %r165
  br i1 %r166, label %bb5, label %bb4

bb5:                                              ; preds = %bb2
  %r167 = load i32, ptr @N, align 4
...
bb7:                                              ; preds = %bb6
  %r175 = sub i32 %r173, 1
  %r176 = add i32 %r175, 0
  %r123 = getelementptr i32, ptr %r100, i32 %r176
  %r177 = load i32, ptr %r123, align 4
  %r126 = getelementptr i32, ptr %r100, i32 %r173
  store i32 %r177, ptr %r126, align 4
  %r129 = getelementptr i32, ptr %r100, i32 %r164
  store i32 %r160, ptr %r129, align 4
  %r178 = sub i32 %r173, 1
  %r179 = add i32 %r178, 0
  br label %bb6
...
bb9:
  ...
  %r184 = add i32 %r183, 0
  %r185 = call i32 @insert(ptr %r132, i32 %r184)
  %r186 = add i32 %r185, 0
  br label %bb10

bb10:                                             ; preds = %bb11, %bb9
  %r187 = phi i32 [ %r182, %bb9 ], [ %r194, %bb11 ]
  %r188 = load i32, ptr @N, align 4
  %r189 = icmp slt i32 %r187, %r188
  br i1 %r189, label %bb11, label %bb12

bb11:                                             ; preds = %bb10
  %r152 = getelementptr [11 x i32], ptr %r132, i32 0, i32 %r187
  %r190 = load i32, ptr %r152, align 4
  %r191 = add i32 %r190, 0
