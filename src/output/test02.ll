...
define i32 @main() {
bb1:
  %r100 = alloca %Node, align 8
  %r101 = alloca [2 x %Node], align 8
  %r102 = alloca i32, align 4
  %r103 = getelementptr %Node, ptr %r100, i32 0, i32 0
  store i32 1, ptr %r103, align 4
  %r104 = getelementptr %Node, ptr %r100, i32 0, i32 1
  store i32 223, ptr %r104, align 4
  %r105 = load i32, ptr %r102, align 4
  %r106 = getelementptr [2 x %Node], ptr %r101, i32 0, i32 1
  %r107 = getelementptr %Node, ptr %r106, i32 0, i32 1
  store i32 %r105, ptr %r107, align 4
  %r108 = getelementptr %Node, ptr @a, i32 0, i32 1
  store i32 1, ptr %r108, align 4
  %r109 = load i32, ptr %r102, align 4
  %r110 = getelementptr [10 x %Node], ptr @b, i32 0, i32 1
