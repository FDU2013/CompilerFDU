...
bb3:                                              ; preds = %bb2
  %r172 = call i32 @getch()
  %r173 = load i32, ptr @ascii_0, align 4
...
bb10:                                             ; preds = %bb9
  %r182 = call i32 @getch()
  %r183 = load i32, ptr @ascii_0, align 4
...
bb19:                                             ; preds = %bb18
  ...
  %r206 = load i32, ptr @ascii_0, align 4
  %r207 = add i32 %r205, %r206
  %r146 = getelementptr [16 x i32], ptr %r137, i32 0, i32 %r202
  store i32 %r207, ptr %r146, align 4
...
bb22:                                             ; preds = %bb21
  %r214 = sub i32 %r212, 1
  %r215 = add i32 %r214, 0
  %r156 = getelementptr [16 x i32], ptr %r137, i32 0, i32 %r215
  %r216 = load i32, ptr %r156, align 4
