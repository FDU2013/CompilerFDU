...
bb1:
  ...
  store i32 200, ptr %r102, align 4
...
bb3:                                              ; preds = %bb2
  ...
  %r107 = getelementptr [10 x i32], ptr @a, i32 0, i32 1
  store i32 %r106, ptr %r107, align 4
  %r108 = load i32, ptr %r100, align 4
  %r109 = add i32 %r108, 1
  store i32 %r109, ptr %r100, align 4
  br label %bb2
...
bb5:                                              ; preds = %bb4
  ...
  %r113 = getelementptr [10 x i32], ptr @a, i32 0, i32 0
