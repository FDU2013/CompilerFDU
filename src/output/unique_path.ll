...
bb7:                                              ; preds = %bb6
  ...
  %r199 = sub i32 %r198, 1
  %r200 = add i32 %r199, 0
  %r123 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r200
...
bb10:                                             ; preds = %bb9
  ...
  %r209 = add i32 %r208, 0
  %r135 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r209
...
bb16:                                             ; preds = %bb15
  ...
  %r231 = add i32 %r230, 1
  %r232 = add i32 %r231, 0
  %r163 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r228
  %r233 = load i32, ptr %r163, align 4
  %r166 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r232
  %r234 = load i32, ptr %r166, align 4
  %r235 = add i32 %r233, %r234
  %r170 = getelementptr [9 x i32], ptr %r108, i32 0, i32 %r224
  store i32 %r235, ptr %r170, align 4
  %r236 = sub i32 %r219, 1
  %r237 = add i32 %r236, 0
  br label %bb15
...
bb14:                                             ; preds = %bb12
  ...
  %r240 = load i32, ptr %r175, align 4
  ret i32 %r240
}
