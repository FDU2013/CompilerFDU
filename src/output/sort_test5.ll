...
bb1:
  ...
  %r222 = add i32 %r103, 0
  %r223 = add i32 0, 0
  %r107 = getelementptr i32, ptr %r100, i32 %r220
  %r224 = load i32, ptr %r107, align 4
  %r225 = add i32 %r224, 0
  %r110 = getelementptr i32, ptr %r100, i32 %r222
  %r226 = load i32, ptr %r110, align 4
  %r113 = getelementptr i32, ptr %r100, i32 %r220
  store i32 %r226, ptr %r113, align 4
  %r116 = getelementptr i32, ptr %r100, i32 %r222
  store i32 %r225, ptr %r116, align 4
  ret i32 0
}
...
bb9:                                              ; preds = %bb4
  %r139 = getelementptr i32, ptr %r117, i32 %r239
  %r245 = load i32, ptr %r139, align 4
  %r142 = getelementptr i32, ptr %r117, i32 %r243
  %r246 = load i32, ptr %r142, align 4
...
bb8:                                              ; preds = %bb7, %bb6
  ...
  %r148 = getelementptr i32, ptr %r117, i32 %r238
  %r251 = load i32, ptr %r148, align 4
  %r151 = getelementptr i32, ptr %r117, i32 %r250
  %r252 = load i32, ptr %r151, align 4
...
bb11:                                             ; preds = %bb8
  %r254 = call i32 @swap(ptr %r117, i32 %r238, i32 %r250)
  %r255 = add i32 %r254, 0
  %r256 = add i32 %r250, 0
  %r257 = mul i32 %r256, 2
  %r258 = add i32 %r257, 1
...
bb15:                                             ; preds = %bb14
  %r271 = sub i32 %r262, 1
  %r272 = add i32 %r271, 0
  %r273 = call i32 @heap_ajust(ptr %r161, i32 %r268, i32 %r272)
  %r274 = add i32 %r273, 0
  %r275 = sub i32 %r268, 1
  %r276 = add i32 %r275, 0
  br label %bb14
...
bb18:                                             ; preds = %bb17
  %r281 = add i32 0, 0
  %r282 = call i32 @swap(ptr %r161, i32 %r281, i32 %r279)
  %r283 = add i32 %r282, 0
  %r284 = sub i32 %r279, 1
  %r285 = add i32 %r284, 0
  %r286 = call i32 @heap_ajust(ptr %r161, i32 %r281, i32 %r285)
  %r287 = add i32 %r286, 0
  %r288 = sub i32 %r279, 1
  %r289 = add i32 %r288, 0
  br label %bb17
...
bb20:
  ...
  %r291 = add i32 0, 0
  %r292 = add i32 0, 0
  %r293 = load i32, ptr @n, align 4
  %r294 = call i32 @heap_sort(ptr %r194, i32 %r293)
  %r295 = add i32 %r294, 0
  br label %bb21

bb21:                                             ; preds = %bb22, %bb20
  %r296 = phi i32 [ %r295, %bb20 ], [ %r303, %bb22 ]
  %r297 = load i32, ptr @n, align 4
  %r298 = icmp slt i32 %r296, %r297
  br i1 %r298, label %bb22, label %bb23

bb22:                                             ; preds = %bb21
  %r213 = getelementptr [10 x i32], ptr %r194, i32 0, i32 %r296
  %r299 = load i32, ptr %r213, align 4
  %r300 = add i32 %r299, 0
