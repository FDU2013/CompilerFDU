...
bb3:                                              ; preds = %bb2
  %r163 = add i32 %r161, 1
  %r108 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r161
  store i32 %r163, ptr %r108, align 4
  %r164 = add i32 %r161, 1
  %r165 = add i32 %r164, 0
  br label %bb2
...
bb5:                                              ; preds = %bb11, %bb4
  ...
  %r178 = load i32, ptr %r124, align 4
...
bb6:                                              ; preds = %bb8
  ...
  %r183 = add i32 %r182, 0
  %r137 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r183
  %r184 = load i32, ptr %r137, align 4
...
bb7:                                              ; preds = %bb8, %bb5
  ...
  %r192 = load i32, ptr %r146, align 4
