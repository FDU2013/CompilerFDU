...
bb4:                                              ; preds = %bb3
  ...
  %r123 = getelementptr i32, ptr %r113, i32 %r156
  store i32 %r160, ptr %r123, align 4
...
bb6:
  ...
  %r167 = add i32 1478, 0
  %r168 = call i32 @split(i32 %r167, ptr %r130)
  %r169 = add i32 %r168, 0
  %r170 = add i32 0, 0
  %r171 = add i32 0, 0
  br label %bb7
...
bb8:                                              ; preds = %bb7
  %r137 = getelementptr [4 x i32], ptr %r130, i32 0, i32 %r172
  %r174 = load i32, ptr %r137, align 4
  %r175 = add i32 %r174, 0
  call void @putint(i32 %r175)
  %r176 = load i32, ptr @newline, align 4
