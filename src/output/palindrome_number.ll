...
bb4:                                              ; preds = %bb3
  ...
  %r121 = getelementptr [4 x i32], ptr %r113, i32 0, i32 %r158
  store i32 %r161, ptr %r121, align 4
