...
bb3:                                              ; preds = %bb2
  %r155 = add i32 %r153, 1
  %r108 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r153
  store i32 %r155, ptr %r108, align 4
  %r156 = add i32 %r153, 1
  %r157 = add i32 %r156, 0
  br label %bb2
...
bb6:                                              ; preds = %bb8
  %r130 = getelementptr [10 x i32], ptr %r102, i32 0, i32 %r172
  %r175 = load i32, ptr %r130, align 4
